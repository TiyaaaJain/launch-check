...
If yes, generate a Marp presentation and export it as a PPTX:
...
style: |
  ...
  .verdict-pursue { background: #4CAF50; color: white; padding: 12px 24px; border-radius: 8px; font-size: 1.4em; font-weight: bold; display: inline-block; }
  .verdict-caution { background: #FFC107; color: #1a1a2e; padding: 12px 24px; border-radius: 8px; font-size: 1.4em; font-weight: bold; display: inline-block; }
  .verdict-no { background: #F44336; color: white; padding: 12px 24px; border-radius: 8px; font-size: 1.4em; font-weight: bold; display: inline-block; }
...
Structure the slides as follows (each `---` is a slide break):

**Slide 1 — Title**: Idea name as H1, verdict badge (use verdict-pursue / verdict-caution / verdict-no class), one-line description, "Generated by /launch-check"

**Slide 2 — The Idea**: What it does, business model (B2B/B2C, pricing model, price point), value category + signal strength

**Slide 3 — Target Customers (ICP)**: Full ICP table with all columns

**Slide 4 — Competitive Landscape**: Competitor table with positioning, weakness, your edge

**Slide 5 — Go-to-Market Channels**: Channel table with fit and specific targets, 2-3 bullets on highest-priority channel

**Slide 6 — Validation Signals**: Signal table with status and reasoning, overall demand read

**Slide 7 — Idea Score**: Score table with all 5 dimensions, use score-high / score-mid / score-low classes, overall score prominent, 3-4 bullet summary

**Slide 8 — Validation Next Steps**: 3 numbered methods with how to run each and what success looks like

**Slide 9 — Verdict & Recommendation**: Should you build? Direct answer, MVP scope or pivot suggestions, one clear next action for this week

**Final slide footer**: The last slide must end with:
```
Made using [launch-check](https://github.com/TiyaaaJain/launch-check) — a Claude Code skill for validating SaaS ideas before you build.
```
